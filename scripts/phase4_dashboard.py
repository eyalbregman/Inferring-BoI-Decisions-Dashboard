...
.tab{appearance:none;border:0;background:none;font:inherit;font-size:13.5px;font-weight:500;cursor:pointer;
...
<div class="wrap">
  ...
  <div class="tabs" role="tablist" aria-label="View">
    <button class="tab" role="tab" data-v="blind" aria-selected="true">Inferring the decision &mdash; reasoning only</button>
    <button class="tab" role="tab" data-v="rate" aria-selected="false">Inferring the decision &mdash; reasoning &plus; prior rate level</button>
    <button class="tab" role="tab" data-v="fed" aria-selected="false">Fed-anchored hawkish&ndash;dovish tone score</button>
  </div>
